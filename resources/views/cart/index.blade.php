                            ...
                            <table>
                                ...
                                <tbody>
                                 @foreach ($cartItem as $item)
                                    <tr>
                                        <td class="product-remove"><a href="{{ route('addtoCart.destroy', $item->id) }}"><i class="pe-7s-close"></i></a></td>
                                        ...
                                        <td class="product-quantity">
                                            <form action="{{route('addtoCart.update',$item->id)}}" method="get">
                        ...
                        <div class="row">
                            <div class="col-md-5 ml-auto">
                                <div class="cart-page-total">
                                    ...
                                    <a href="{{ route('cart.chec kout') }}">Proceed to checkout</a>
                                </div>
                            </div>
                        </div>
                </div>
